    ...
    return (
        <div className='homeAboutBox'>
            <div className='homeAboutImgContainer'>
                <img className='homeAboutImg1' src={aboutImg1} />
                <img className='homeAboutImg2' src={aboutImg2} />
            </div>
            <div className='homeAboutContainer'>
                <div className='homeAboutTitleContainer'>
                    <h1 className='homeAboutTitle'>Little Lemon</h1>
                    <h4 className='homeAboutTitle2'>Chicago</h4>
                </div>
